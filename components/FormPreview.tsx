...
export function FormPreview({
  ...
  return (
    <section id={panelId} role={panelId ? "tabpanel" : undefined} aria-labelledby={tabId} aria-label={`${lang} form preview`} className="form-paper roll-paper rounded-sm border border-line shadow-[0_2px_8px_rgba(0,0,0,0.06)] px-4 pt-4 pb-5">
